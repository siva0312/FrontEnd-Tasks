...
const Kodaikanal = () => {
  return (
    <div className='container mb-5 pt-5' id="Kodaikanal">
      <h3>03.Kodaikanal</h3>
      <div className='d-flex'>
      <img 
        className="distimg"
        src={require("./Home/Kodaikanal.jpeg")}
        alt="chennai">
       </img>
        ...
        <div className='card-group'>
          ...
          <img 
            ...
            <div className="card-body">
              ...
              <p className="card-text"> FDhanushkodi was until a few years ago a wonderful temple on the southern tip of India. However, due to a... </p>
