    ...
    <div className='container'>
      ...
      <section className='mt-5 pt-1 pb-4' id='img1'>
        ...
        <div className='d-flex mt-5'>
          <img 
            style={{ width: '20%' }}
            src={require("./Home/kodaikanal1.jpeg")}
            alt="Green Valley">
          </img> 
          <span className='ms-4 me-3 disttext '>
      ...
      <section className='mt-5 pb-4' id='img2'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("./Home/kodaikanal2.jpeg")}
            alt="Kodai Lake">
          </img>
        </div>
      </section>
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
            style={{ width: '20%' }}
            src={require("./Home/kodaikanal3.jpeg")}
      ...
      <section className='mt-5 pb-4' id='img4'>
        <div className='d-flex mt-5'> 
          ...
          <img 
            style={{ width: '20%' }}
            src={require("./Home/kodaikanal4.jpeg")}
            alt="Pillar Rockse">
          </img>
        </div>
      </section>
      ...
      <section className='mt-5 pb-4' id='img2'>
        <div className='d-flex mt-5'> 
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Any tourist who is interested in gods gift to this planet, the wondrous flora, and in knowing about variousspecies of plants must make it a point to visit the orchid garden and the green house in the Botanical garden.
          </p>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <section className='mt-5 pb-4' id='img3'>
        ...
        <img 
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Tucked within the Western Ghats of Tamil Nadu, Meghamalai in Theni district is the kind of hidden paradise that you read about in books, complete with exhilarating trek routes, breathtaking scenes and an excellent opportunity to take abreak from your everyday life in the lap of nature.
          </p>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            The Highwavys Mountain, locally called the Meghamalai, is an undulating terrain of peaks belonging to theVarushanad Range of Western Ghats, in Theni district of Tamil Nadu. Located at an elevation of 1,500 metres above the sealevel, Meghamalai is covered in the trademark green of Sahyadri, thus earning the name "Pacha Kumachi in Tamil, meaning 'Green Peaks '. Green peaks of Meghamalai Source Up until recently, the Meghamalai Hills were restricted to private estatesof tea and coffee plantations
          </p>
          </span>
        </div>
      </section>
      <section className='mt-5 pb-4' id='img4'>
        <div className='d-flex mt-5'> 
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Suruli Falls is a beautiful waterfall in the Theni district of Tamil Nadu and one of the major tourist attractions ofTheni as well It is a perfect destination to get up close and personal with the nature and cool off in its pristine waters
          </p>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
